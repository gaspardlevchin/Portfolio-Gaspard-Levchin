...
OUT = ROOT / "pdf" / "portfolio-gaspard-levchin.pdf"
WEB_OUT = ROOT / "web" / "assets" / "portfolio-gaspard-levchin.pdf"
BG_IMAGE = ROOT / "web" / "assets" / "levchin-background.jpg"

W, H = A4

INK = HexColor("#efe6dd")
MUTED = Color(239 / 255, 230 / 255, 221 / 255, alpha=0.66)
FAINT = Color(239 / 255, 230 / 255, 221 / 255, alpha=0.14)
WARM = HexColor("#d09f68")
BG = HexColor("#050505")
PANEL = HexColor("#080706")
...
def page_base(c):
    ...
    set_alpha(c, 0.08)
    c.setFillColor(INK)
    c.rect(0, H - 138, W, 1, fill=1, stroke=0)
    reset_alpha(c)
...
def cover(c):
    page_base(c)
    x = 62
    line(c, x, 620, x, 718, Color(239 / 255, 230 / 255, 221 / 255, alpha=0.36), 0.8)
    c.setFillColor(INK)
    ...
    paragraph(c, lead, x + 24, 495, 360, 11.5, 18, Color(239 / 255, 230 / 255, 221 / 255, alpha=0.78))
    ...
    c.drawString(x + 44, 285, "Version portfolio - V1 sombre")

    line(c, x + 24, 160, W - 62, 160, Color(239 / 255, 230 / 255, 221 / 255, alpha=0.18))
    c.setFillColor(MUTED)
...
def signature_page(c):
    ...
    for i, (title, copy) in enumerate(territories):
        ...
        line(c, x, y0, x + cell_w, y0, Color(208 / 255, 159 / 255, 104 / 255, alpha=0.45), 0.8)
        c.setFillColor(WARM)
...
def projects_page(c):
    ...
    for num, title, role, copy, date in projects:
        line(c, 54, y + 20, W - 54, y + 20, Color(239 / 255, 230 / 255, 221 / 255, alpha=0.14))
        c.setFillColor(WARM)
        c.setFont("Helvetica-Bold", 8)
        ...
        c.setFillColor(Color(239 / 255, 230 / 255, 221 / 255, alpha=0.52))
...
def pathway_page(c):
    ...
    for date, title, copy in timeline:
        line(c, 54, y + 18, W - 54, y + 18, Color(239 / 255, 230 / 255, 221 / 255, alpha=0.13))
        c.setFillColor(WARM)
