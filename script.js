...
const translations = {
  en: {
    ...
    "home.hero.eyebrow": "Art direction",
    "home.hero.lead": "I work across art direction, image, design and fashion to build clear, sensitive visual worlds ready to be produced.",
    ...
    "home.signature.body": "Image, retail, design & fashion: I connect visual culture, attention to detail and on-the-ground standards.",
    "home.signature.profileCta": "Read the profile",
    "home.territories.label": "Territories",
    "home.territory.art": "Art direction",
    "home.territory.art.body": "References, moodboards, intentions, visual coherence.",
    ...
    "home.territory.design.body": "Lines, materials, silhouettes, objects, garments, use.",
    "home.territory.retail": "High-end retail",
    "home.territory.retail.body": "Advice, product presentation, merchandising, on-the-ground standards.",
    ...
    "home.contact.body": "A project, an image, an intention: let's give it a clear, precise and considered form.",
