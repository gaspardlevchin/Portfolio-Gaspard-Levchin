...
const translations = {
  en: {
    ...
    "home.hero.eyebrow": "Image, brand & visual direction / Paris",
    "home.hero.lead": "A precise eye for shaping images, objects and visual experiences with care, from the first moodboard to the final delivery.",
    ...
    "home.territory.art.body": "References, moodboards, visual intentions and overall coherence.",
    "home.territory.image": "Image",
    "home.territory.image.body": "Composition, framing, light, shooting and post-production.",
    "home.territory.design": "Design & fashion",
    "home.territory.design.body": "Reading lines, materials and silhouettes across objects, garments and use.",
    "home.territory.retail": "High-end retail",
    "home.territory.retail.body": "Advice, product presentation, visual merchandising and on-the-ground standards.",
    ...
    "home.contact.body": "For a mission, an image to produce or a project to shape, I can step in with a precise eye, a clear method and close attention to the final result.",
