...
const translations = {
  en: {
    ...
    "profile.heading": "A visual point of view built through image, material and experience.",
    "profile.lead": "I build my path around one recurring search: giving an image, an object or a space the right presence. What interests me is not only what can be seen, but the feeling it leaves behind: a line, a texture, a silence, a way of holding attention.",
    "profile.vision.label": "Eye",
    "profile.block.origin.kicker": "Origin of the eye",
    "profile.block.origin.title": "Observing before producing.",
    "profile.block.origin.body": "My relationship to image comes from an instinctive attention to forms, faces, silhouettes and spaces. I like understanding why a scene works, why a material attracts, why a composition feels obvious when it is in fact carefully built.",
    "profile.block.interests.kicker": "What interests me",
    "profile.block.interests.title": "Precision without coldness.",
    "profile.block.interests.body": "I am drawn to worlds where detail matters: high-end retail, architecture, photography, objects, fashion and the way an experience becomes stronger when it is held with discipline.",
    "profile.block.build.kicker": "What I am building",
    "profile.block.build.title": "A language connecting design and fashion.",
    "profile.block.build.body": "LEVCHIN comes from this desire to connect disciplines: to think of a house, an image, a piece, a space and a digital presence as parts of one visual territory.",
